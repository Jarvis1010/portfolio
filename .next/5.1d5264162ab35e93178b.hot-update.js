...
var Border = __WEBPACK_IMPORTED_MODULE_1_styled_components__["d" /* default */].div(_templateObject2, function (props) {
  return props.top ? "top" : "bottom";
}, function (props) {
...
function (_Component) {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref4 = BoxTitle.__proto__ || Object.getPrototypeOf(BoxTitle)).call.apply(_ref4, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      ...
      value: function value(node) {
        if (node && !_this.node) {
          ...
          var borderlength = (parentWidth - afterWidth) / 2 - buffer;
  ...
  _createClass(BoxTitle, [{
    ...
    value: function render() {
      ...
      return this.state.mounted ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(BoxHeading, _extends({}, props, {
        ref: this.handleRef,
        inverse: inverse,
        top: top,
        as: element in elements && element,
        element: element,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 121
        }
      }), children, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Border, {
        inverse: inverse,
        top: top,
        width: this.state.borderlength,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 130
        }
...
Object.defineProperty(BoxTitle, "defaultProps", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: {
...
//# sourceMappingURL=5.1d5264162ab35e93178b.hot-update.js.map