...
var type = {
  ...
  medium: {
    background: "linear-gradient(to right, ".concat(__WEBPACK_IMPORTED_MODULE_1__constants_styled_constants__["w" /* mediumGrey */], " 0%, #d0d0d0 100%)"),
    color: __WEBPACK_IMPORTED_MODULE_1__constants_styled_constants__["a" /* black */]
  },
  // eslint-disable-line no-use-before-define
  dark: {
    background: "linear-gradient(to right, ".concat(__WEBPACK_IMPORTED_MODULE_1__constants_styled_constants__["f" /* darkGrey */], " 0%, #676767 100%)"),
...
//# sourceMappingURL=5.e76b6fe73809ef66caed.hot-update.js.map