...
var type = {
  ...
  // eslint-disable-line no-use-before-define
  dark: {
    "background-color": "linear-gradient(to right, ".concat(__WEBPACK_IMPORTED_MODULE_1__constants_styled_constants__["w" /* mediumGrey */], " 0%, ").concat(__WEBPACK_IMPORTED_MODULE_1__constants_styled_constants__["f" /* darkGrey */], " 100%)"),
...
}; //background: linear-gradient(to right, ${mediumGrey} 0%, ${darkGrey} 100%);
...
//# sourceMappingURL=5.3bfc6dafd734534d210d.hot-update.js.map