  ...
  function BoxTitle() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref4 = BoxTitle.__proto__ || Object.getPrototypeOf(BoxTitle)).call.apply(_ref4, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      ...
      value: function value() {
        ...
        var fontSizeInPixels = BASE_FONT_SIZE * parseFloat(elements[as].subtitle);
        console.log(__WEBPACK_IMPORTED_MODULE_2_string_pixel_width___default()(txt, {
          size: fontSizeInPixels
        }));
        return txt.length > 0 ? __WEBPACK_IMPORTED_MODULE_2_string_pixel_width___default()(txt) / 2 : 0;
      }
    }), _temp));
  }
...
//# sourceMappingURL=5.0441fbff2b07df824546.hot-update.js.map