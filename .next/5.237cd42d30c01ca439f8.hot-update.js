...
var BoxHeading = __WEBPACK_IMPORTED_MODULE_1_styled_components__["d" /* default */].h2(_templateObject, console.log, function (props) {
...
function (_Component) {
  ...
  function BoxTitle() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref4 = BoxTitle.__proto__ || Object.getPrototypeOf(BoxTitle)).call.apply(_ref4, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      ...
      writable: true,
      value: null
    }), Object.defineProperty(_assertThisInitialized(_this), "init", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        var _this$node$getBoundin = _this.node.getBoundingClientRect(),
            parentWidth = _this$node$getBoundin.width;

        var _window$getComputedSt = window.getComputedStyle(_this.node, "::after"),
...
//# sourceMappingURL=5.237cd42d30c01ca439f8.hot-update.js.map