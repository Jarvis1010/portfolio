...
function (_React$Component2) {
  _inherits(LandingComponent, _React$Component2);
  ...
  function LandingComponent() {
    ...
    _this2 = _possibleConstructorReturn(this, (_getPrototypeOf3 = _getPrototypeOf(LandingComponent)).call.apply(_getPrototypeOf3, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "scroll", function () {
      document.querySelector("#inner").scrollTop = window.innerHeight;
    });
...
//# sourceMappingURL=_app.js.e0c8fdb2ee1fb2182270.hot-update.js.map